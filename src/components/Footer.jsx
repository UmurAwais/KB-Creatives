            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a 
                  ...
                  className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white/40 hover:text-brand hover:bg-brand/10 transition-all duration-300 border border-white/10 hover:border-brand/30"
