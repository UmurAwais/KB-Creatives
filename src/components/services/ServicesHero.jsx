...
const ServicesHero = () => {
  return (
    <section className="relative min-h-[85vh] lg:min-h-screen bg-white flex items-center pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-24 overflow-hidden">
            ...
            <MotionSection>
              <div className="relative inline-block lg:block text-left w-full lg:w-auto">
                <div className="flex items-center gap-4 mb-6 justify-center lg:justify-start">
                  ...
                  <span className="text-brand font-outfit text-sm font-bold uppercase tracking-[0.5em]">Our Expertise</span>
                </div>
                ...
                <div className="flex flex-wrap gap-8 justify-center lg:justify-start border-t border-gray-100 pt-10">
                  <div className="text-left">
                    <div className="text-4xl font-teko font-bold text-gray-900 tracking-tight leading-none">10+</div>
                    <div className="text-gray-400 font-outfit text-[10px] uppercase font-bold tracking-widest mt-2 px-0.5">Specializations</div>
                  </div>
                  <div className="text-left">
                    <div className="text-4xl font-teko font-bold text-gray-900 tracking-tight leading-none">24/7</div>
                    <div className="text-gray-400 font-outfit text-[10px] uppercase font-bold tracking-widest mt-2 px-0.5">Expert Support</div>
                  </div>
                  <div className="text-left">
                    <div className="text-4xl font-teko font-bold text-gray-900 tracking-tight leading-none">100%</div>
                    <div className="text-gray-400 font-outfit text-[10px] uppercase font-bold tracking-widest mt-2 px-0.5">Client Satisfaction</div>
                  </div>
                </div>
              </div>
            </MotionSection>
              ...
              <div className="relative w-full aspect-4/5 sm:aspect-4/3 lg:aspect-square max-w-125 lg:max-w-none z-10 overflow-visible group">
                ...
                <div className="relative h-full rounded-[2.5rem] overflow-hidden shadow-2xl z-10 border-8 border-white">
                  ...
                  <div className="absolute top-8 right-8 bg-white/90 backdrop-blur-md p-5 rounded-3xl shadow-xl z-20 animate-bounce-slow">
                    <div className="text-brand font-teko text-5xl font-bold leading-none">TOP</div>
                    <div className="text-gray-900 font-outfit text-[10px] font-bold uppercase tracking-widest mt-1">Tier Solutions</div>
                  </div>
                </div>
