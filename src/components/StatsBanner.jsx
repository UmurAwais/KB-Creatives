    ...
    <div className="w-full max-w-site mx-auto px-6 py-12" ref={sectionRef}>
      <div className={`relative overflow-hidden rounded-[2.5rem] bg-black p-8 md:p-14 lg:p-20 shadow-2xl transition-all duration-[1200ms] cubic-bezier(0.2, 0, 0, 1) group/banner ${
        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10 border-b border-white/10 pb-16 mb-16 text-left">
            <div className={`max-w-[280px] xs:max-w-[320px] sm:max-w-3xl transition-all duration-[800ms] delay-300 cubic-bezier(0.2, 0, 0, 1) ${
              isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
            }`}>
              <h2 className="text-white text-[38px] xs:text-4xl md:text-5xl lg:text-7xl leading-[1.1] lg:leading-[0.9] font-teko font-bold uppercase tracking-tight cursor-default">
                <span className="inline-block transition-transform duration-500">
                  Empowering Brands With Cutting-Edge{' '}
                </span>
                <br />
                <div className="relative inline-flex items-center justify-start gap-3 mt-2 w-full lg:w-auto">
                  <span 
                    ref={digitalRef}
